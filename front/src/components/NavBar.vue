  ...
  >
    <div class="container-fluid">
      ...
      <button
        ...
        data-bs-target="#navbarProper"
        aria-controls="navbarProper"
        aria-expanded="false"
      ...
      <div class="navbar-collapse collapse" id="navbarProper">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0 nav-pills">
          ...
          <li class="nav-item" v-if="currentUser">
            <router-link
              ...
              class="nav-link px-2"
              active-class="active bg-secondary"
              >Показатели здоровья</router-link
            >
          </li>
          ...
          <li class="nav-item dropdown">
            <a
              role="button"
              class="nav-link px-2 position-relative dropdown-toggle"
        ...
        <div
          v-if="currentUser"
          class="d-lg-flex justify-content-lg-end mb-2 mb-md-0"
        >
